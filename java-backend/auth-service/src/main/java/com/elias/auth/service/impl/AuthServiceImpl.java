...
import com.elias.common.client.NotificationClient;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void sendVerificationCode(String email, String type) {
        ...
        notificationClient.sendCode(email, authMailProperties.getUsername());
