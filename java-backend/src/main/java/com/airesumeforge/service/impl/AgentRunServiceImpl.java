...
import com.airesumeforge.dto.agent.run.request.AgentRunJobMessage;
import com.airesumeforge.dto.agent.run.request.AgentApproveRequest;
import com.airesumeforge.dto.agent.run.request.AgentCancelRequest;
import com.airesumeforge.dto.agent.run.request.AgentContinueRequest;
import com.airesumeforge.dto.agent.run.request.AgentRunStartRequest;
...
import com.airesumeforge.entity.AgentMessage;
import com.airesumeforge.entity.AgentSession;
import com.airesumeforge.entity.AiAgentRun;
import com.airesumeforge.entity.AiRunEvent;
import com.airesumeforge.entity.Resume;
import com.airesumeforge.exception.BusinessException;
import com.airesumeforge.mapper.AgentMessageMapper;
import com.airesumeforge.mapper.AgentSessionMapper;
import com.airesumeforge.mapper.AiAgentRunMapper;
import com.airesumeforge.mapper.AiRunEventMapper;
import com.airesumeforge.mapper.ResumeMapper;
import com.airesumeforge.service.AgentRunJobProducer;
import com.airesumeforge.service.AgentRunService;
import com.airesumeforge.service.ResumePatchService;
import com.airesumeforge.dto.agent.run.response.AgentApproveResponse;
import com.airesumeforge.dto.agent.run.response.AgentEventResponse;
import com.airesumeforge.dto.agent.run.response.AgentRunDetailResponse;
import com.airesumeforge.dto.agent.run.response.AgentRunQueueResponse;
...
public class AgentRunServiceImpl implements AgentRunService {
    ...
    public AgentRunQueueResponse continueRun(Long runId, AgentContinueRequest request) {
        ...
        publishAfterCommit(AgentRunJobMessage.builder()
                ...
                .targetSectionId(run.getTargetSectionId())
